...
// OLED on ESP32 (use valid I2C pins)
#define I2C_SDA     17
#define I2C_SCL     16
...
IPAddress local_IP(10, 151, 240, 92);
...
// === The exact same mode_1 to mode_8 and onWebSocketEvent from your original code ===
// (copy/paste from your message – already ESP32-compatible)
